; ModuleID = 'subtract.ll'
source_filename = "subtract.c"
...
bb:
  %tmp = getelementptr inbounds i8*, i8** %arg1, i64 1
  %tmp2 = load i8*, i8** %tmp, align 8
  %tmp3 = call i32 @atoi(i8* %tmp2) #3
  %tmp4 = getelementptr inbounds i8*, i8** %arg1, i64 2
  %tmp5 = load i8*, i8** %tmp4, align 8
  %tmp6 = call i32 @atoi(i8* %tmp5) #3
  %0 = xor i32 %tmp3, %tmp6
  %1 = xor i32 %tmp6, -1
  %2 = and i32 %tmp3, %1
  %3 = mul i32 2, %2
  %tmp7 = sub i32 %3, %0
  %tmp8 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str, i64 0, i64 0), i32 %tmp7)
  ret i32 0
}
